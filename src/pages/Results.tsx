...
const stats = [
  { label: "Win Rate", value: "82.4%", icon: Target, color: "text-emerald-200" },
  { label: "Profit Factor", value: "3.24", icon: TrendingUp, color: "text-white" },
  { label: "Avg. Risk/Reward", value: "1:3.5", icon: ShieldCheck, color: "text-emerald-200" },
];
...
export const Results = () => (
  <div className="relative overflow-hidden pb-16">
    ...
    <PageHero
      ...
      metrics={[
        { label: "Total Gain", value: "+48,250 Pips", helper: "Trailing twelve-month performance snapshot" },
      ...
      <div className="grid gap-8 lg:grid-cols-[1.6fr_0.9fr]">
        <Reveal className="site-panel p-8 md:p-10">
          <SectionHeading
            ...
            description="This curve presents the directional effect of structured execution, not a promise of future results."
          />
