    ...
    <>
      ...
      <div className="space-y-16">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-8">
          <div className="space-y-4">
            <h1 className="text-5xl font-black text-white italic tracking-tighter uppercase leading-[0.8] mb-2">
              Performance <span className="text-emerald-500">Telemetry</span>
            </h1>
        ...
        <div className="grid gap-10 lg:grid-cols-[1.6fr_0.9fr]">
          ...
          <div className="space-y-6">
            {stats.map((stat, index) => (
              <div key={stat.label} className="p-8 rounded-3xl bg-white/[0.02] border border-white/5 hover:border-emerald-500/20 transition-all group">
                <div className="flex items-center gap-6">
                  <div className="flex h-14 w-14 items-center justify-center rounded-2xl bg-white/5 border border-white/5 group-hover:bg-emerald-500/10 transition-all">
                    <stat.icon className={cn("h-7 w-7", stat.color)} />
                  </div>
                  <div>
                    <div className="text-3xl font-black tracking-tighter text-white italic">{stat.value}</div>
                    <div className="mt-1 text-[9px] font-black uppercase tracking-[0.3em] text-white/20 group-hover:text-emerald-500/60 transition-colors">{stat.label}</div>
                  </div>
                </div>
              </div>
            ))}

            <div className="p-8 rounded-[2.5rem] bg-grad-primary/5 border border-emerald-500/10 space-y-4">
        ...
        <section className="grid grid-cols-1 md:grid-cols-2 gap-10 py-12 border-t border-white/5">
           <div className="p-10 rounded-[3rem] bg-white/[0.02] border border-white/5 space-y-6 group hover:border-emerald-500/20 transition-all">
           ...
           <div className="p-10 rounded-[3rem] bg-white/[0.03] border border-white/10 space-y-6 group hover:border-emerald-500/20 transition-all">
