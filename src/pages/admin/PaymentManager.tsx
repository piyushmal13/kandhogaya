              ...
              <div>
                <div className="flex items-start justify-between mb-6">
                  ...
                  <div className={cn(
                    ...
                    proof.status === 'pending' ? "bg-yellow-500/10 text-yellow-500 border-yellow-500/20" :
                    proof.status === 'approved' ? "bg-emerald-500/10 text-emerald-500 border-emerald-500/20" :
