...
import { Briefcase, ShieldCheck, ArrowRight, Upload, FileText, CheckCircle2, AlertCircle } from "lucide-react";
...
export const Hiring = () => {
  ...
  // Fetch internal hiring positions dynamically
  useEffect(() => {
    const fetchPositions = async () => {
      ...
      try {
        ...
        console.error("Crash fetching internal hiring positions:", err);
      } finally {
        ...
        .insert([
          {
            ...
            metadata: {
              ...
              source: "internal_careers_portal",
  ...
  return (
    <div className="relative overflow-hidden min-h-screen bg-[#010203] text-[#BAC9CC] font-sans pb-24">
      <PageMeta
        title="IFX Trades Careers — Join the Quantitative Desk"
        description="Join our internal quantitative desk. We source high-caliber systems architects and quants continuously every month, every day, matching operational scale."
        path="/hiring"
        keywords={["quant jobs", "low latency C++ developer jobs", "quantitative portfolio analyst hiring", "IFX Trades careers"]}
      />
        ...
        <div className="max-w-5xl mx-auto px-6 text-center">
          ...
          <Reveal delay={0.15}>
            <p className="text-lg md:text-xl text-[#8A9AAB] max-w-3xl mx-auto font-light leading-relaxed mb-12">
              We recruit developers, systems architects, and macro researchers on an ongoing basis. We hire every month, every day, adapting dynamically to our quantitative desk requirements.
            </p>
          </Reveal>
          ...
          <Reveal delay={0.1}>
            <div className="space-y-6">
              <div className="inline-flex items-center gap-2 text-xs font-bold text-blue-400 uppercase tracking-widest font-mono">
                <ShieldCheck className="h-4 w-4 text-cyan-400" /> SYSTEMIC TRADING OPERATIONS
              </div>
              ...
              <div className="flex flex-col gap-3 pt-2">
                <div className="flex items-center gap-3 text-sm text-white/80">
                  ...
                  Demonstrated lock-free concurrency loops in C++ / Rust
                </div>
                <div className="flex items-center gap-3 text-sm text-white/80">
                  <div className="w-1.5 h-1.5 rounded-full bg-cyan-400" />
                  Cryptographic track record validation via verified links
                </div>
                <div className="flex items-center gap-3 text-sm text-white/80">
                  <div className="w-1.5 h-1.5 rounded-full bg-cyan-400" />
                  Understanding of prime-of-prime ECN routing mechanics
                </div>
              </div>
            </div>
          </Reveal>
          ...
          <Reveal delay={0.2} className="relative">
            <div className="site-panel p-8 relative overflow-hidden border border-blue-500/10 bg-[#040507]/40 backdrop-blur-md rounded-3xl">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="text-xs font-bold text-white">Quantitative Council</div>
                  <div className="text-[10px] text-[#849396] font-mono">IFX EXECUTIVE HEAD</div>
                </div>
              </div>
            </div>
          </Reveal>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <textarea
                      ...
                      required
                      rows={5}
                      placeholder="Outline your quantitative backtests, C++/Rust low-latency coding experience, or technical highlights..."
