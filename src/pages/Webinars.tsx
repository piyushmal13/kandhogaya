...
import { ComingSoonWebinar } from '@/pages/ComingSoonWebinar';
...
export const Webinars = () => {
  ...
  // If Pitch Mode is active, bypass all standard layouts and render the full-screen Apple-style holding page
