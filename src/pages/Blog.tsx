    ...
    <DashboardLayout>
      <div className="relative overflow-hidden pb-20">
        ...
        <PageSection className="pt-0">
          <div className="grid grid-cols-1 gap-12 md:grid-cols-2 lg:grid-cols-2 max-w-6xl mx-auto">
                  ...
                  <Link to={`/blog/${post.slug}`} className="block h-full">
                    <div className="relative h-full flex flex-col bg-[var(--color7)] border border-white/5 rounded-[32px] overflow-hidden hover:border-emerald-500/30 transition-all duration-500 hover:shadow-[0_0_50px_rgba(16,185,129,0.05)]">
                      ...
                      <div className="flex flex-1 flex-col p-10 pt-6">
                        ...
                        {/* Title */}
                        <h3 className="mb-6 text-3xl font-black leading-tight text-white group-hover:text-emerald-400 transition-colors tracking-tighter">
                          {post.title}
                        </h3>
