        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7">
            <motion.div 
              ...
              viewport={{ once: true }}
              className="inline-flex items-center gap-2 px-3 py-1 rounded bg-emerald-500/10 border border-emerald-500/20 text-emerald-400 text-xs font-mono tracking-widest mb-6"
            >
            ...
            <motion.h2 
              ...
              className="text-4xl md:text-6xl font-bold text-white mb-6 tracking-tighter leading-[1.1]"
            >
            ...
            >
              <div className="flex items-center gap-4">
                <div className="w-14 h-14 rounded-full border-2 border-emerald-500/30 p-0.5">
                ...
                <div>
                  <div className="text-white font-bold text-sm">Alex Wright</div>
                  <div className="text-emerald-500 text-[10px] font-mono tracking-wider uppercase">Head Quant</div>
                </div>
              </div>
              <div className="flex items-center gap-4">
                <div className="w-14 h-14 rounded-full border-2 border-white/10 p-0.5">
                ...
                <div>
                  ...
                  <div className="text-gray-500 text-[10px] font-mono tracking-wider uppercase">Risk Manager</div>
                </div>
              </div>
            </motion.div>
            ...
            >
              <span className="text-xs font-mono text-gray-600 uppercase tracking-widest">Sponsored By:</span>
              <div className="flex gap-6 opacity-50 grayscale hover:grayscale-0 transition-all duration-500">
                <div className="flex items-center gap-2">
                  <ShieldCheck className="w-5 h-5 text-white" />
                  <span className="text-white font-bold tracking-tight">APEX LIQUIDITY</span>
                </div>
                <div className="flex items-center gap-2">
                  <Activity className="w-5 h-5 text-white" />
                  <span className="text-white font-bold tracking-tight">QUANT.AI</span>
                </div>
              </div>
            </motion.div>
          </div>
          ...
          <div className="lg:col-span-5">
            <motion.div 
              ...
              viewport={{ once: true }}
              className="bg-[#0a0a0a] border border-white/10 rounded-3xl p-8 relative overflow-hidden group shadow-2xl"
            >
              ...
              <div className="flex items-center justify-between mb-8">
                ...
                <div className="px-3 py-1 rounded-full bg-white/5 border border-white/10 text-[10px] font-bold text-white uppercase tracking-wider">
                  Limited Seats
                </div>
              </div>
              ...
              <div className="grid grid-cols-3 gap-4 mb-8">
                {[
                  ...
                  <div key={i} className="bg-black border border-white/10 rounded-xl py-4 flex flex-col items-center justify-center">
                    <span className="text-3xl font-bold text-white font-mono tracking-tighter">{format(item.value)}</span>
              ...
              <button className="w-full py-4 bg-emerald-500 hover:bg-emerald-400 text-black font-bold rounded-xl transition-all duration-300 flex items-center justify-center gap-2 group/btn shadow-[0_0_20px_rgba(16,185,129,0.3)] hover:shadow-[0_0_30px_rgba(16,185,129,0.5)]">
                Reserve Free Seat
