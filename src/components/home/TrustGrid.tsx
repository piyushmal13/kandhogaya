...
const PILLARS = [
  {
    ...
    desc: "No deposits, no active fund custody, and no brokerage conflicts. Verified regulatory compliance across India and UAE.",
    color: "#3B82F6",
    num: "01",
  },
  {
    ...
    desc: "Expert systems designed to route directly to institutional liquidity providers, bypassing retail market makers.",
    color: "#06B6D4",
    num: "02",
  },
  {
    ...
    desc: "Every execution signal is archived with timestamped parameters. High-fidelity 36-month operational audit logs.",
    color: "#8B5CF6",
    num: "03",
  },
  {
    ...
    desc: "Proprietary gold macro research built on institutional order flow and volume profile indicators.",
    color: "#EC4899",
    num: "04",
  },
  {
    ...
    desc: "Operationally compliant across three sovereign jurisdictions. Trusted by quantitative desks in 40+ countries.",
    color: "#3B82F6",
    num: "05",
  },
  {
    ...
    desc: "Awarded for outstanding achievements in quantitative curriculum and professional client outcome excellence.",
    color: "#F43F5E",
    num: "06",
  },
];
        ...
        >
          <div>
            ...
            <div
              ...
              style={{ fontFamily: "IBM Plex Mono, monospace" }}
            >
              Quantitative Research · Audited Performance · Direct Desk Entry
            </div>
          </div>
          <Link
            to="/webinars"
