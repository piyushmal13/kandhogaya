      ...
      >
        <div
          className={cn(
            ...
            scrolled
              ? "h-12 sm:h-16 bg-[#040608]/80 border border-white/5 shadow-[0_30px_60px_-15px_rgba(0,0,0,0.8)] backdrop-blur-[48px] saturate-[180%]"
              : "h-14 sm:h-20 bg-transparent border border-transparent"
          )}
        >
          {/* Logo */}
          <Link
