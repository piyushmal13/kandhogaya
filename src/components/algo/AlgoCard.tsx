      ...
      <div className="p-8 flex-1 flex flex-col">
        ...
        <div className="grid grid-cols-2 gap-4 mb-8">
          <div className="bg-white/5 rounded-xl p-3 border border-white/5">
            ...
            <div className="text-lg font-bold text-emerald-400 font-mono">{algo.win_rate}%</div>
          </div>
          <div className="bg-white/5 rounded-xl p-3 border border-white/5">
        ...
        <div className="mb-8">
          ...
          <div className="flex flex-wrap gap-2">
            {algo.supported_assets?.map((asset: string, i: number) => (
        ...
        <div className="mt-auto pt-6 border-t border-white/5 flex items-center justify-between">
          <div>
            ...
            <div className="text-xl font-bold text-white">${algo.monthly_price}<span className="text-sm text-gray-500 font-normal">/mo</span></div>
          </div>
          <button 
