      ...
      {products.map((product, index) => (
        ...
        >
          ...
          <motion.div 
            ...
            className={cn(
              "relative h-full overflow-hidden rounded-[2rem] sm:rounded-[3.5rem] bg-black/40 backdrop-blur-3xl border border-white/5 transition-all duration-700 preserve-3d",
              "hover:border-emerald-500/20 shadow-2xl",
              "flex flex-col p-5 sm:p-12 z-10"
            )}
          >
            ...
            <div className="flex justify-between items-start mb-6 sm:mb-12">
              <div className="space-y-4">
                ...
                {product.type === 'algorithm' && (
                  <div className="flex items-center gap-3 text-[9px] sm:text-[10px] font-black text-emerald-400 uppercase tracking-widest font-mono">
              ...
              {showPremiumBadges && product.isPremium && (
                <div className="flex items-center gap-2 px-3 py-1.5 sm:px-4 sm:py-2 rounded-full bg-amber-500/10 border border-amber-500/20 shadow-[0_0_20px_rgba(245,158,11,0.1)]">
                  ...
                  <span className="text-[8px] sm:text-[9px] md:text-[10px] font-black text-amber-500 uppercase tracking-[0.1em]">Elite Tier</span>
                </div>
              )}
            </div>
            ...
            {/* Deployment Action */}
            <div className="mt-6 sm:mt-12 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 sm:gap-6">
              <div className="flex flex-col">
                <span className="text-[8px] sm:text-[9px] font-black text-white/20 uppercase tracking-widest mb-1 sm:mb-2">Base Allocation</span>
