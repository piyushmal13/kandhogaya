...
const STUDIES = [
  {
    ...
    tags: ['MT5', 'Elite-Config', 'Elite-Risk'],
  ...
  },
  {
    ...
    tags: ['Python', 'Custom API', 'Elite-Backtest'],
  ...
  },
  {
    ...
    tags: ['AWS Lambda', 'Performance Opt', 'Elite-Sentry'],
...
export function CaseStudyShowcase() {
  return (
    <section id="case-studies" className="py-32 md:py-48 px-6 bg-[#020202] border-t border-white/[0.05] relative overflow-hidden">
      {/* Background Decor */}
      <div className="absolute bottom-0 left-0 w-[600px] h-[600px] bg-[#00A3FF]/5 blur-[150px] rounded-full opacity-10 -z-10" />
      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row items-end justify-between mb-32 gap-10">
          <div className="max-w-2xl">
            ...
            >
              Proven <br />
              <span className="italic font-serif text-gradient-gold">Execution.</span>
            </motion.h2>
          ...
          <button 
            ...
            className="group px-10 py-5 border border-white/[0.08] text-white font-black text-[10px] uppercase tracking-[0.3em] rounded-2xl transition-all duration-500 hover:bg-white/[0.04] hover:border-white/[0.2] active:scale-95 flex items-center gap-3 cursor-pointer"
          >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          {STUDIES.map((study, i) => (
            <motion.div
              ...
              viewport={{ once: true }}
              className="group relative rounded-[3.5rem] overflow-hidden border border-white/[0.06] bg-[#080B12] transition-all duration-700 hover:border-[#00A3FF]/30 hover:shadow-2xl"
            >
              <div className="aspect-[4/5] overflow-hidden relative grayscale-[0.8] group-hover:grayscale-0 transition-all duration-1000 ease-out">
                ...
                <div className="absolute bottom-10 left-10 right-10">
                  <div className="flex flex-wrap gap-2.5 mb-6">
                    {study.tags.map(tag => (
                      <span key={tag} className="px-3 py-1.5 rounded-lg bg-[#00A3FF]/10 backdrop-blur-xl text-[8px] font-black tracking-widest text-[#00A3FF] border border-[#00A3FF]/20 uppercase italic">
                        {tag}
                      </span>
                    ))}
                  </div>
              ...
              <div className="p-10 border-t border-white/[0.06] bg-[#080B12]">
                <div className="text-5xl font-black text-[#00A3FF] tracking-tighter mb-2 italic">{study.result}</div>
