...
const STATIC_URLS = [
  ...
  { loc: '/marketplace', changefreq: 'weekly',  priority: '0.90' },
  { loc: '/results',     changefreq: 'weekly',  priority: '0.90' },
  { loc: '/pricing',     changefreq: 'weekly',  priority: '0.90' },
  { loc: '/affiliate',   changefreq: 'weekly',  priority: '0.90' },
  { loc: '/b2b/liquidity', changefreq: 'weekly',  priority: '0.90' },
  { loc: '/b2b/white-label', changefreq: 'weekly',  priority: '0.90' },
  ...
  { loc: '/hiring',      changefreq: 'monthly', priority: '0.60' },
  { loc: '/privacy',     changefreq: 'yearly',  priority: '0.40' },
  { loc: '/terms',       changefreq: 'yearly',  priority: '0.40' },
  { loc: '/risk',        changefreq: 'yearly',  priority: '0.40' },
  { loc: '/cookies',     changefreq: 'yearly',  priority: '0.30' },
];
